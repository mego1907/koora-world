...
const ChampionshipCard = ({ championshipName, fromDay, toDay }) => {
  return (
    <div 
      ...
      <div className="flex items-center justify-between w-full md:px-8 px-4 mt-3 text-white">
        <p>
          <span>من يوم :</span>
          <span className="mr-1 md:text-sm text-xs font-semibold">1-10-2023</span>
        </p>
        <p>
          <span>الي يوم :</span>
          <span className="mr-1 md:text-sm text-xs font-semibold">29-11-2023</span>
        </p>
      </div>
    </div>
  )
