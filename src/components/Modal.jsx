...
const Modal = ({ children, open, setOpen, onClose, width = "md:w-5/12", overflow = false }) => {
  return (
    <div className='relative'>
      ...
      <div 
        className={`fixed z-50 ${width} w-full p-2 top-1/2 -translate-y-1/2 -translate-x-1/2 
          ${open ? "scale-y-100" : "scale-y-0"}
          ${overflow ? "overflow-y-scroll h-[90%]" : ""}
          bg-[#306ba5] rounded-md shadow-md  left-1/2 transition-all`}>
